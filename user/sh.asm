...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	de2b8b93          	addi	s7,s7,-542 # 1398 <malloc+0x152>
  ...
  while(peek(ps, es, "<>")){
     ...
     5cc:	db050513          	addi	a0,a0,-592 # 1378 <malloc+0x132>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6b4:	cf060613          	addi	a2,a2,-784 # 13a0 <malloc+0x15a>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6e4:	ce0b0b13          	addi	s6,s6,-800 # 13c0 <malloc+0x17a>
  ...
  return ret;
     ...
     71e:	c8e50513          	addi	a0,a0,-882 # 13a8 <malloc+0x162>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     780:	c3450513          	addi	a0,a0,-972 # 13b0 <malloc+0x16a>
...
000000000000079a <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7ba:	c1260613          	addi	a2,a2,-1006 # 13c8 <malloc+0x182>
     7be:	85ce                	mv	a1,s3
     7c0:	854a                	mv	a0,s2
...
0000000000000808 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     82a:	baaa0a13          	addi	s4,s4,-1110 # 13d0 <malloc+0x18a>
  ...
  if(peek(ps, es, ";")){
     ...
     860:	b7c60613          	addi	a2,a2,-1156 # 13d8 <malloc+0x192>
     864:	85ce                	mv	a1,s3
     866:	854a                	mv	a0,s2
...
00000000000008b0 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8c6:	ade60613          	addi	a2,a2,-1314 # 13a0 <malloc+0x15a>
  ...
  if(!peek(ps, es, ")"))
     ...
     8f6:	afe60613          	addi	a2,a2,-1282 # 13f0 <malloc+0x1aa>
     8fa:	85ca                	mv	a1,s2
     8fc:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     938:	aac50513          	addi	a0,a0,-1364 # 13e0 <malloc+0x19a>
     93c:	fffff097          	auipc	ra,0xfffff
     940:	71a080e7          	jalr	1818(ra) # 56 <panic>
    panic("syntax - missing )");
     944:	00001517          	auipc	a0,0x1
     948:	ab450513          	addi	a0,a0,-1356 # 13f8 <malloc+0x1b2>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     974:	ae870713          	addi	a4,a4,-1304 # 1458 <malloc+0x212>
...
00000000000009ec <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a20:	9f460613          	addi	a2,a2,-1548 # 1410 <malloc+0x1ca>
     a24:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a56:	9c658593          	addi	a1,a1,-1594 # 1418 <malloc+0x1d2>
     a5a:	4509                	li	a0,2
     a5c:	00000097          	auipc	ra,0x0
     a60:	704080e7          	jalr	1796(ra) # 1160 <fprintf>
    panic("syntax");
     a64:	00001517          	auipc	a0,0x1
     a68:	94450513          	addi	a0,a0,-1724 # 13a8 <malloc+0x162>
...
0000000000000a74 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a88:	9a448493          	addi	s1,s1,-1628 # 1428 <malloc+0x1e2>
     a8c:	4589                	li	a1,2
     a8e:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b3e:	8f658593          	addi	a1,a1,-1802 # 1430 <malloc+0x1ea>
     b42:	4509                	li	a0,2
     b44:	00000097          	auipc	ra,0x0
     b48:	61c080e7          	jalr	1564(ra) # 1160 <fprintf>
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     edc:	f3e080e7          	jalr	-194(ra) # e16 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
     ...
     efa:	0805c963          	bltz	a1,f8c <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f0e:	5c650513          	addi	a0,a0,1478 # 14d0 <digits>
     f12:	883a                	mv	a6,a4
  ...
  if(neg)
     f36:	00088c63          	beqz	a7,f4e <printint+0x66>
    buf[i++] = '-';
  ...
  while(--i >= 0)
     f4e:	02e05863          	blez	a4,f7e <printint+0x96>
     f52:	fc040793          	addi	a5,s0,-64
     f56:	00e78933          	add	s2,a5,a4
     f5a:	fff78993          	addi	s3,a5,-1
     f5e:	99ba                	add	s3,s3,a4
     f60:	377d                	addiw	a4,a4,-1
     f62:	1702                	slli	a4,a4,0x20
     f64:	9301                	srli	a4,a4,0x20
     f66:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
     f6a:	fff94583          	lbu	a1,-1(s2)
     f6e:	8526                	mv	a0,s1
     f70:	00000097          	auipc	ra,0x0
     f74:	f56080e7          	jalr	-170(ra) # ec6 <putc>
  while(--i >= 0)
     f78:	197d                	addi	s2,s2,-1
     f7a:	ff3918e3          	bne	s2,s3,f6a <printint+0x82>
}
     f7e:	70e2                	ld	ra,56(sp)
     f80:	7442                	ld	s0,48(sp)
     f82:	74a2                	ld	s1,40(sp)
     f84:	7902                	ld	s2,32(sp)
     f86:	69e2                	ld	s3,24(sp)
...
vprintf(int fd, const char *fmt, va_list ap)
{
     ...
     f9e:	f44e                	sd	s3,40(sp)
     fa0:	f052                	sd	s4,32(sp)
     fa2:	ec56                	sd	s5,24(sp)
     fa4:	e85a                	sd	s6,16(sp)
     fa6:	e45e                	sd	s7,8(sp)
     fa8:	e062                	sd	s8,0(sp)
     faa:	0880                	addi	s0,sp,80
  char *s;
  int c, i, state;
  ...
  for(i = 0; fmt[i]; i++){
     ...
     fb0:	18090c63          	beqz	s2,1148 <vprintf+0x1b4>
     fb4:	8aaa                	mv	s5,a0
     fb6:	8bb2                	mv	s7,a2
  ...
  state = 0;
     ...
     fc2:	4b55                	li	s6,21
     fc4:	a839                	j	fe2 <vprintf+0x4e>
        putc(fd, c);
     fc6:	85ca                	mv	a1,s2
     fc8:	8556                	mv	a0,s5
     fca:	00000097          	auipc	ra,0x0
     fce:	efc080e7          	jalr	-260(ra) # ec6 <putc>
     fd2:	a019                	j	fd8 <vprintf+0x44>
    } else if(state == '%'){
     fd4:	01498d63          	beq	s3,s4,fee <vprintf+0x5a>
  for(i = 0; fmt[i]; i++){
     fd8:	0485                	addi	s1,s1,1
     fda:	fff4c903          	lbu	s2,-1(s1)
     fde:	16090563          	beqz	s2,1148 <vprintf+0x1b4>
    if(state == 0){
     fe2:	fe0999e3          	bnez	s3,fd4 <vprintf+0x40>
      if(c == '%'){
     fe6:	ff4910e3          	bne	s2,s4,fc6 <vprintf+0x32>
        state = '%';
     fea:	89d2                	mv	s3,s4
     fec:	b7f5                	j	fd8 <vprintf+0x44>
      if(c == 'd'){
     fee:	13490263          	beq	s2,s4,1112 <vprintf+0x17e>
     ff2:	f9d9079b          	addiw	a5,s2,-99
     ff6:	0ff7f793          	zext.b	a5,a5
     ffa:	12fb6563          	bltu	s6,a5,1124 <vprintf+0x190>
     ffe:	f9d9079b          	addiw	a5,s2,-99
    1002:	0ff7f713          	zext.b	a4,a5
    1006:	10eb6f63          	bltu	s6,a4,1124 <vprintf+0x190>
    100a:	00271793          	slli	a5,a4,0x2
    100e:	00000717          	auipc	a4,0x0
    1012:	46a70713          	addi	a4,a4,1130 # 1478 <malloc+0x232>
    ...
    1030:	ebc080e7          	jalr	-324(ra) # ee8 <printint>
    1034:	8bca                	mv	s7,s2
      } else {
      ...
      state = 0;
    1036:	4981                	li	s3,0
    1038:	b745                	j	fd8 <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 10, 0);
    103a:	008b8913          	addi	s2,s7,8
    103e:	4681                	li	a3,0
    1040:	4629                	li	a2,10
    1042:	000ba583          	lw	a1,0(s7)
    1046:	8556                	mv	a0,s5
    1048:	00000097          	auipc	ra,0x0
    104c:	ea0080e7          	jalr	-352(ra) # ee8 <printint>
    1050:	8bca                	mv	s7,s2
      state = 0;
    1052:	4981                	li	s3,0
    1054:	b751                	j	fd8 <vprintf+0x44>
    ...
    1068:	e84080e7          	jalr	-380(ra) # ee8 <printint>
    106c:	8bca                	mv	s7,s2
      state = 0;
    106e:	4981                	li	s3,0
    1070:	b7a5                	j	fd8 <vprintf+0x44>
        printptr(fd, va_arg(ap, uint64));
    1072:	008b8c13          	addi	s8,s7,8
    1076:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    107a:	03000593          	li	a1,48
    107e:	8556                	mv	a0,s5
    1080:	00000097          	auipc	ra,0x0
    1084:	e46080e7          	jalr	-442(ra) # ec6 <putc>
  putc(fd, 'x');
    1088:	07800593          	li	a1,120
    108c:	8556                	mv	a0,s5
    108e:	00000097          	auipc	ra,0x0
    1092:	e38080e7          	jalr	-456(ra) # ec6 <putc>
    1096:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    1098:	00000b97          	auipc	s7,0x0
    109c:	438b8b93          	addi	s7,s7,1080 # 14d0 <digits>
    10a0:	03c9d793          	srli	a5,s3,0x3c
    10a4:	97de                	add	a5,a5,s7
    10a6:	0007c583          	lbu	a1,0(a5)
    10aa:	8556                	mv	a0,s5
    10ac:	00000097          	auipc	ra,0x0
    10b0:	e1a080e7          	jalr	-486(ra) # ec6 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10b4:	0992                	slli	s3,s3,0x4
    10b6:	397d                	addiw	s2,s2,-1
    10b8:	fe0914e3          	bnez	s2,10a0 <vprintf+0x10c>
        printptr(fd, va_arg(ap, uint64));
    10bc:	8be2                	mv	s7,s8
      state = 0;
    10be:	4981                	li	s3,0
    10c0:	bf21                	j	fd8 <vprintf+0x44>
        s = va_arg(ap, char*);
    10c2:	008b8993          	addi	s3,s7,8
    10c6:	000bb903          	ld	s2,0(s7)
        if(s == 0)
    10ca:	02090163          	beqz	s2,10ec <vprintf+0x158>
        while(*s != 0){
    10ce:	00094583          	lbu	a1,0(s2)
    10d2:	c9a5                	beqz	a1,1142 <vprintf+0x1ae>
          putc(fd, *s);
    10d4:	8556                	mv	a0,s5
    10d6:	00000097          	auipc	ra,0x0
    10da:	df0080e7          	jalr	-528(ra) # ec6 <putc>
          s++;
    10de:	0905                	addi	s2,s2,1
        while(*s != 0){
    10e0:	00094583          	lbu	a1,0(s2)
    10e4:	f9e5                	bnez	a1,10d4 <vprintf+0x140>
        s = va_arg(ap, char*);
    10e6:	8bce                	mv	s7,s3
      state = 0;
    10e8:	4981                	li	s3,0
    10ea:	b5fd                	j	fd8 <vprintf+0x44>
          s = "(null)";
    10ec:	00000917          	auipc	s2,0x0
    10f0:	38490913          	addi	s2,s2,900 # 1470 <malloc+0x22a>
        while(*s != 0){
    10f4:	02800593          	li	a1,40
    10f8:	bff1                	j	10d4 <vprintf+0x140>
        putc(fd, va_arg(ap, uint));
    10fa:	008b8913          	addi	s2,s7,8
    10fe:	000bc583          	lbu	a1,0(s7)
    1102:	8556                	mv	a0,s5
    1104:	00000097          	auipc	ra,0x0
    1108:	dc2080e7          	jalr	-574(ra) # ec6 <putc>
    110c:	8bca                	mv	s7,s2
      state = 0;
    110e:	4981                	li	s3,0
    1110:	b5e1                	j	fd8 <vprintf+0x44>
        putc(fd, c);
    1112:	02500593          	li	a1,37
    1116:	8556                	mv	a0,s5
    1118:	00000097          	auipc	ra,0x0
    111c:	dae080e7          	jalr	-594(ra) # ec6 <putc>
      state = 0;
    1120:	4981                	li	s3,0
    1122:	bd5d                	j	fd8 <vprintf+0x44>
        putc(fd, '%');
    1124:	02500593          	li	a1,37
    1128:	8556                	mv	a0,s5
    112a:	00000097          	auipc	ra,0x0
    112e:	d9c080e7          	jalr	-612(ra) # ec6 <putc>
        putc(fd, c);
    1132:	85ca                	mv	a1,s2
    1134:	8556                	mv	a0,s5
    1136:	00000097          	auipc	ra,0x0
    113a:	d90080e7          	jalr	-624(ra) # ec6 <putc>
      state = 0;
    113e:	4981                	li	s3,0
    1140:	bd61                	j	fd8 <vprintf+0x44>
        s = va_arg(ap, char*);
    1142:	8bce                	mv	s7,s3
      state = 0;
    1144:	4981                	li	s3,0
    1146:	bd49                	j	fd8 <vprintf+0x44>
    }
  }
}
    ...
    1150:	79a2                	ld	s3,40(sp)
    1152:	7a02                	ld	s4,32(sp)
    1154:	6ae2                	ld	s5,24(sp)
    1156:	6b42                	ld	s6,16(sp)
    1158:	6ba2                	ld	s7,8(sp)
    115a:	6c02                	ld	s8,0(sp)
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  vprintf(fd, fmt, ap);
    ...
    1182:	e16080e7          	jalr	-490(ra) # f94 <vprintf>
}
...
printf(const char *fmt, ...)
{
  ...
  vprintf(1, fmt, ap);
    ...
    11b8:	de0080e7          	jalr	-544(ra) # f94 <vprintf>
}
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1320:	b62080e7          	jalr	-1182(ra) # e7e <sbrk>
  if(p == (char*)-1)
