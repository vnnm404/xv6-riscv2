...
go(int which_child)
{
  ...
  chdir("/");
      ...
      da:	2a250513          	addi	a0,a0,674 # 1378 <malloc+0x112>
      de:	00001097          	auipc	ra,0x1
      e2:	dc0080e7          	jalr	-576(ra) # e9e <chdir>
      e6:	00001997          	auipc	s3,0x1
      ea:	2a298993          	addi	s3,s3,674 # 1388 <malloc+0x122>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	29098993          	addi	s3,s3,656 # 1380 <malloc+0x11a>
  uint64 iters = 0;
      f8:	4481                	li	s1,0
  int fd = -1;
      fa:	5a7d                	li	s4,-1
      fc:	00001917          	auipc	s2,0x1
     100:	53c90913          	addi	s2,s2,1340 # 1638 <malloc+0x3d2>
    ...
    if(what == 1){
     ...
     10e:	28650513          	addi	a0,a0,646 # 1390 <malloc+0x12a>
    ...
    if(what == 1){
     ...
     168:	23c50513          	addi	a0,a0,572 # 13a0 <malloc+0x13a>
     ...
     182:	21250513          	addi	a0,a0,530 # 1390 <malloc+0x12a>
     ...
     194:	1c050513          	addi	a0,a0,448 # 1350 <malloc+0xea>
     ...
     1a6:	21650513          	addi	a0,a0,534 # 13b8 <malloc+0x152>
     1aa:	00001097          	auipc	ra,0x1
     1ae:	cd4080e7          	jalr	-812(ra) # e7e <unlink>
      chdir("/");
     1b2:	00001517          	auipc	a0,0x1
     1b6:	1c650513          	addi	a0,a0,454 # 1378 <malloc+0x112>
     1ba:	00001097          	auipc	ra,0x1
     1be:	ce4080e7          	jalr	-796(ra) # e9e <chdir>
     1c2:	b785                	j	122 <go+0xaa>
        printf("grind: chdir grindir failed\n");
     1c4:	00001517          	auipc	a0,0x1
     1c8:	19450513          	addi	a0,a0,404 # 1358 <malloc+0xf2>
     ...
     1f0:	1d450513          	addi	a0,a0,468 # 13c0 <malloc+0x15a>
     ...
     212:	1c250513          	addi	a0,a0,450 # 13d0 <malloc+0x16a>
     ...
     256:	13e50513          	addi	a0,a0,318 # 1390 <malloc+0x12a>
     25a:	00001097          	auipc	ra,0x1
     25e:	c3c080e7          	jalr	-964(ra) # e96 <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     262:	20200593          	li	a1,514
     266:	00001517          	auipc	a0,0x1
     26a:	18250513          	addi	a0,a0,386 # 13e8 <malloc+0x182>
     ...
     282:	17a50513          	addi	a0,a0,378 # 13f8 <malloc+0x192>
     ...
     294:	17050513          	addi	a0,a0,368 # 1400 <malloc+0x19a>
     298:	00001097          	auipc	ra,0x1
     29c:	bfe080e7          	jalr	-1026(ra) # e96 <mkdir>
      close(open("grindir/../b/b", O_CREATE|O_RDWR));
     2a0:	20200593          	li	a1,514
     2a4:	00001517          	auipc	a0,0x1
     2a8:	16450513          	addi	a0,a0,356 # 1408 <malloc+0x1a2>
     ...
     2c0:	15c50513          	addi	a0,a0,348 # 1418 <malloc+0x1b2>
     ...
     2d2:	11250513          	addi	a0,a0,274 # 13e0 <malloc+0x17a>
     2d6:	00001097          	auipc	ra,0x1
     2da:	ba8080e7          	jalr	-1112(ra) # e7e <unlink>
      link("../grindir/./../a", "../b");
     2de:	00001597          	auipc	a1,0x1
     2e2:	0da58593          	addi	a1,a1,218 # 13b8 <malloc+0x152>
     2e6:	00001517          	auipc	a0,0x1
     2ea:	13a50513          	addi	a0,a0,314 # 1420 <malloc+0x1ba>
     ...
     2fc:	14050513          	addi	a0,a0,320 # 1438 <malloc+0x1d2>
     300:	00001097          	auipc	ra,0x1
     304:	b7e080e7          	jalr	-1154(ra) # e7e <unlink>
      link(".././b", "/grindir/../a");
     308:	00001597          	auipc	a1,0x1
     30c:	0b858593          	addi	a1,a1,184 # 13c0 <malloc+0x15a>
     310:	00001517          	auipc	a0,0x1
     314:	13850513          	addi	a0,a0,312 # 1448 <malloc+0x1e2>
     ...
     348:	10c50513          	addi	a0,a0,268 # 1450 <malloc+0x1ea>
     ...
     396:	0be50513          	addi	a0,a0,190 # 1450 <malloc+0x1ea>
     ...
     3f6:	07650513          	addi	a0,a0,118 # 1468 <malloc+0x202>
     ...
     422:	01250513          	addi	a0,a0,18 # 1430 <malloc+0x1ca>
     ...
     444:	01050513          	addi	a0,a0,16 # 1450 <malloc+0x1ea>
     ...
     45e:	01e50513          	addi	a0,a0,30 # 1478 <malloc+0x212>
     ...
     4ac:	fa850513          	addi	a0,a0,-88 # 1450 <malloc+0x1ea>
     ...
     508:	f8c50513          	addi	a0,a0,-116 # 1490 <malloc+0x22a>
     ...
     534:	f7858593          	addi	a1,a1,-136 # 14a8 <malloc+0x242>
     ...
     636:	e1e50513          	addi	a0,a0,-482 # 1450 <malloc+0x1ea>
     ...
     650:	ea450513          	addi	a0,a0,-348 # 14f0 <malloc+0x28a>
     ...
     664:	e9050513          	addi	a0,a0,-368 # 14f0 <malloc+0x28a>
     ...
     67c:	e3058593          	addi	a1,a1,-464 # 14a8 <malloc+0x242>
     ...
     6c2:	e3250513          	addi	a0,a0,-462 # 14f0 <malloc+0x28a>
     6c6:	00000097          	auipc	ra,0x0
     6ca:	7b8080e7          	jalr	1976(ra) # e7e <unlink>
     6ce:	bc91                	j	122 <go+0xaa>
        printf("grind: create c failed\n");
     6d0:	00001517          	auipc	a0,0x1
     6d4:	e2850513          	addi	a0,a0,-472 # 14f8 <malloc+0x292>
     ...
     6ee:	e2650513          	addi	a0,a0,-474 # 1510 <malloc+0x2aa>
     ...
     708:	e2450513          	addi	a0,a0,-476 # 1528 <malloc+0x2c2>
     ...
     724:	e2050513          	addi	a0,a0,-480 # 1540 <malloc+0x2da>
     ...
     73e:	e2e50513          	addi	a0,a0,-466 # 1568 <malloc+0x302>
     ...
     826:	de658593          	addi	a1,a1,-538 # 1608 <malloc+0x3a2>
     ...
     84a:	dca50513          	addi	a0,a0,-566 # 1610 <malloc+0x3aa>
     ...
     864:	c3058593          	addi	a1,a1,-976 # 1490 <malloc+0x22a>
     868:	4509                	li	a0,2
     ...
     880:	c1458593          	addi	a1,a1,-1004 # 1490 <malloc+0x22a>
     884:	4509                	li	a0,2
     ...
     8dc:	cb858593          	addi	a1,a1,-840 # 1590 <malloc+0x32a>
     8e0:	4509                	li	a0,2
     ...
     950:	b0458593          	addi	a1,a1,-1276 # 1450 <malloc+0x1ea>
     954:	4509                	li	a0,2
     ...
     99c:	bf858593          	addi	a1,a1,-1032 # 1590 <malloc+0x32a>
     9a0:	4509                	li	a0,2
     ...
     9e0:	bb458593          	addi	a1,a1,-1100 # 1590 <malloc+0x32a>
     9e4:	4509                	li	a0,2
     ...
     a48:	a0c58593          	addi	a1,a1,-1524 # 1450 <malloc+0x1ea>
     a4c:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     a70:	9c450513          	addi	a0,a0,-1596 # 1430 <malloc+0x1ca>
     a74:	00000097          	auipc	ra,0x0
     a78:	40a080e7          	jalr	1034(ra) # e7e <unlink>
  unlink("b");
     a7c:	00001517          	auipc	a0,0x1
     a80:	96450513          	addi	a0,a0,-1692 # 13e0 <malloc+0x17a>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     aba:	99a50513          	addi	a0,a0,-1638 # 1450 <malloc+0x1ea>
  ...
  if(pid2 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b02:	95250513          	addi	a0,a0,-1710 # 1450 <malloc+0x1ea>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f2e:	7ce50513          	addi	a0,a0,1998 # 16f8 <digits>
     f32:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    102a:	00271793          	slli	a5,a4,0x2
    102e:	00000717          	auipc	a4,0x0
    1032:	67270713          	addi	a4,a4,1650 # 16a0 <malloc+0x43a>
  ...
  putc(fd, 'x');
    ...
    10bc:	640b8b93          	addi	s7,s7,1600 # 16f8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1110:	58c90913          	addi	s2,s2,1420 # 1698 <malloc+0x432>
        while(*s != 0){
    ...
    121a:	00e6ea63          	bltu	a3,a4,122e <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    1234:	02059813          	slli	a6,a1,0x20
    1238:	01c85713          	srli	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    1248:	02061593          	slli	a1,a2,0x20
    124c:	01c5d713          	srli	a4,a1,0x1c
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12b6:	d5e90913          	addi	s2,s2,-674 # 2010 <freep>
  if(p == (char*)-1)
    12ba:	5afd                	li	s5,-1
    12bc:	a895                	j	1330 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    12be:	00001797          	auipc	a5,0x1
    12c2:	14a78793          	addi	a5,a5,330 # 2408 <base>
    ...
    12de:	c798                	sw	a4,8(a5)
        p += p->s.size;
    12e0:	02071693          	slli	a3,a4,0x20
    12e4:	01c6d713          	srli	a4,a3,0x1c
